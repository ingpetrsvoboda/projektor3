...
echo interval();
    $databaze = Framework_Config::DATABAZE_PROJEKTOR;

    $tabulka = "akce";
    $objektStruktura = Projektor_Model_Auto_Cache_Struktury::getStrukturuTabulky($databaze, $tabulka);
    vypisTabulku2($objektStruktura);
...
function vypisTabulku2(Projektor_Model_Auto_Cache_StrukturaTabulky $objektStruktura)
    {
     ...
     */
    function dejNazvy() {
    return Projektor_Model_Auto_Cache_Struktury::getStrukturuTabulky($databaze, $tabulka)->nazvy;
    }
    ...
    return Projektor_Model_Auto_Cache_Struktury::getStrukturuTabulky($databaze, $tabulka)->primaryKeyFieldName;
    }
     ...
     */
    function dejKlice() {
    return Projektor_Model_Auto_Cache_Struktury::getStrukturuTabulky($databaze, $tabulka)->pk;
    }
     ...
     */
    function dejTypy() {
    return Projektor_Model_Auto_Cache_Struktury::getStrukturuTabulky($databaze, $tabulka)->typy;
    }
     ...
     */
    function dejDelky() {
    return Projektor_Model_Auto_Cache_Struktury::getStrukturuTabulky($databaze, $tabulka)->delky;
    }
?>

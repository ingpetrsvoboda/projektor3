...
private static function Najdi_kolize ($query,$iducast){
  ...
  //--
  Table_UcKolizeData::$zjistovane_kolize=array();
  Table_UcKolizeData::$nastava_kolize_ve_zjistovanych = false;   
  //echo "NAJDI KOLIZE";
  ...
  while($zaznam_s_kolize = $data->fetch_assoc())  {    //pro  pozadovane kontroly (kolize) sestavuji dotazy
        ...
        //--
        array_push (Table_UcKolizeData::$zjistovane_kolize, $zaznam_s_kolize['id_s_typ_kolize']);
        ...
        if   ($query_kolize) {
          ...
          //while ($zaznam_kolize = $data_kolize->fetch_assoc()) {     
           ...
           if  ( $zaznam_kolize['kolize_nastala'] ) {   // kolize nastava
              ...
              //--/
              Table_UcKolizeData::$nastava_kolize_ve_zjistovanych = true;       // nastavi priznak, ze alespon jedna zjistovana kolize skutecne nastava
            ...
            if ($zaznam_minula) {
              $kolize = new Table_UcKolizeData($iducast, $zaznam_s_kolize['id_s_typ_kolize'],
...
//zapis do uc_kolize_table pro kazdou nastalou s_kolizi
              foreach ($idcka_skolizi as $id_skolize) {    //zapisovana policka jsou v $pole
                ...
                $kolize = new Table_UcKolizeData ($iducast, (int)$id_skolize,

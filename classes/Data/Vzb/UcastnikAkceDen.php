<?php
class Data_Vzb_UcastnikAkceDen
{
	const TABULKA = "vzb_ucastnik_akce_den";
	const ID = "id_vyb_ucastnik_akce_den";
	...
	/*public static function dejStavy($ucastnik, $akceUcastnika)
	 {
		...
		$radky = $dbh->prepare($query)->execute(Data_Vzb_UcastnikAkce::ID_S_STAV_UCASTNIK_AKCE_FK, Data_Vzb_UcastnikAkce::TABULKA,

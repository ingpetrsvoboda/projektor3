...
class Data_Seznam_SPrechodUcastnikAkce extends Data_Iterator
{
	public $id;
	public $text;
	public $plnyText;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Data_Seznam_SPrechodUcastnikAkce($radek[self::TEXT], $radek[self::PLNY_TEXT],
	 ...
	 * @param Data_Seznam_SStavUcastnikAkce $stavPred Stav ucastnika pred prechodem, tj.soucasny stav.
	 * @param Data_Seznam_SStavUcastnikAkce $stavPo Stav ucastnika po prechodu, tj budouci stav.

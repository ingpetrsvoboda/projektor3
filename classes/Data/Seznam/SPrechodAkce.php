...
class Data_Seznam_SPrechodAkce extends Data_Iterator
{
	public $id;
	public $text;
	public $plnyText;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Data_Seznam_SPrechodAkce($radek[self::TEXT], $radek[self::PLNY_TEXT],
	 ...
	 * @param Data_Seznam_SStavAkce $stavPred Stav Akce pred prechodem, tj.soucasny stav.
	 * @param Data_Seznam_SStavAkce $stavPo Stav Akce po prechodu, tj budouci stav.

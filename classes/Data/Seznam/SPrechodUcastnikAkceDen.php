...
class Data_Seznam_SPrechodUcastnikAkceDen extends Data_Iterator
{
	public $id;
	public $text;
	public $plnyText;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Data_Seznam_SPrechodUcastnikAkceDen($radek[self::TEXT], $radek[self::PLNY_TEXT],
	 ...
	 * @param Data_Seznam_SStavUcastnikAkceDen $stavPred Stav ucastnika pred prechodem, tj.soucasny stav.
	 * @param Data_Seznam_SStavUcastnikAkceDen $stavPo Stav ucastnika po prechodu, tj budouci stav.

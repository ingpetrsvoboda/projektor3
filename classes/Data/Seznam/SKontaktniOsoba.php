...
class Data_Seznam_SKontaktniOsoba extends Data_Iterator
{
	public $id;
	public $jmeno;
	public $prijmeni;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Data_Seznam_SKontaktniOsoba($radek[self::JMENO], $radek[self::PRIJMENI], $radek[self::TELEFON_PRACE], $radek[self::TELEFON_MOBIL],

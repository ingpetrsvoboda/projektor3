...
class Data_User extends Data_Iterator
{
    ...
    public function __construct($username,$name,$debug, $povolen_zapis, $id=NULL)
    {
        $this->id = $id;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Data_User($radek[self::USERNAME], $radek[self::NAME], $radek[self::DEBUG], $radek[self::POVOLEN_ZAPIS], $radek[self::ID]);
	}

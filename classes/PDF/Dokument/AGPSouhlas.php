...
//        }
    public function __construct($zajemce) {
     ...
     {             
            ...
            $userKontext = App_Kontext::getUserKontext();
...
//        $pdf = parent::__construct($zajemce);
	...
	$this->pdf->Ln(7); 	 
     ...
     public function uloz()
     {
        ...
        $exportConfig = App_Config::najdiSekciPodleJmena(App_Config::NAZEV_SEKCE_EXPORT_V_XML);
        if (!file_exists($exportConfig->pdf->directory)) throw new Exception('*** Chyba v '.__CLASS__."->".__METHOD__.': '."Neexistuje adresář pro export pdf souboru zadaný v App_Config: ".$exportConfig->pdf->directory);

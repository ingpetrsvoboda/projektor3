<?php
  ...
  foreach($pdfpole  as $klic => $hodnota) {
    ...
    $pdfpaticka = PDFContext::dejPaticku();
		$pdfpaticka->text("Dohoda o účasti v projektu „Rodina není handicap v Plzeňském kraji“  Účastník: ".$Ucastnik->identifikator);
    ...
    $stranaDodavatel = new PDF_Odstavec;
    ...
    $spolecneUzaviraji1 = new PDF_Odstavec;
    ...
    $spolecneUzaviraji2 = new PDF_Odstavec;		     
...
$odstavec2_1 = new PDF_Odstavec;
    $odstavec2_1->text("2.1. Předmětem dohody je stanovení podmínek účasti Účastníka na aktivitách projektu Rodina není handicap a úprava práv a povinností Stran dohody při realizaci těchto aktivit.");
...
$odstavec3_1 = new PDF_Odstavec;
    $odstavec3_1->text("3.1. Účastník potvrzuje, že se účastnil výběrové schůzky, kde byl seznámen s prezentací projektu Rodina není handicap, na půdě Úřadu práce podepsal Souhlas se zařazením do projektu ESF a obdržel Základní poučení účastníka v projektu ESF.");
    $odstavec3_1->predsazeni(6);
    $odstavec3_1->odsazeniZleva(6);

$odstavec3_2 = new PDF_Odstavec;
...
$odstavec3_3_b = new PDF_Odstavec;
...
$odstavec3_3_c = new PDF_Odstavec;
...
$odstavec3_8_b= new PDF_Odstavec;
...
$odstavec3_8_c= new PDF_Odstavec;
    $odstavec3_8_c->text("c)   účastnit se kurzů projektu Rodina není handicap");
    $odstavec3_8_c->predsazeni(6);
    $odstavec3_8_c->odsazeniZleva(14);

$odstavec3_9 = new PDF_Odstavec;
...
$odstavec3_10_a = new PDF_Odstavec;
...
$odstavec3_10_b = new PDF_Odstavec;
...
$odstavec3_10_c = new PDF_Odstavec;
...
$odstavec3_10_d = new PDF_Odstavec;
...
$odstavec4_1 = new PDF_Odstavec;
    $odstavec4_1->text("4.1. K ukončení účasti účastníka v projektu Rodina není handicap dojde v následujících případech:");
    $odstavec4_1->predsazeni(6);
    $odstavec4_1->odsazeniZleva(6);


$odstavec4_1_a = new PDF_Odstavec;
...
$odstavec4_1_a_1 = new PDF_Odstavec;
    $odstavec4_1_a_1->text("-  tato doba je 6 měsíců");
    $odstavec4_1_a_1->predsazeni(3);
    $odstavec4_1_a_1->odsazeniZleva(24);
    
$odstavec4_1_a_2 = new PDF_Odstavec;
...
$odstavec4_1_b = new PDF_Odstavec;
...
$odstavec4_1_b_1 = new PDF_Odstavec;
...
$odstavec4_1_b_2 = new PDF_Odstavec;
...
$odstavec4_1_c = new PDF_Odstavec;
...
$odstavec4_1_c_1 = new PDF_Odstavec;
...
$odstavec5_1_d = new PDF_Odstavec;
    $odstavec5_1_d->text("d)   příspěvek na vyjádření o zdravotním stavu před nástupem do rekvalifikačního kurzu");
    $odstavec5_1_d->predsazeni(6);
    $odstavec5_1_d->odsazeniZleva(14);
$odstavec5_1_e = new PDF_Odstavec;
...
$odstavec5_2 = new PDF_Odstavec;
    $odstavec5_2->text("5.2. Bližší specifikace uvedených druhů přímé podpory je uvedena v dokumentu Základní informace účastníka projektu Rodina není handicap.");
    $odstavec5_2->predsazeni(6);
    $odstavec5_2->odsazeniZleva(6);     

$odstavec5_3 = new PDF_Odstavec;
...
$odstavec8 = new PDF_Odstavec;
    $odstavec8 -> Nadpis("8. Závěrečná ustanovení");   

$odstavec8_1 = new PDF_Odstavec;
...
$odstavec8_2 = new PDF_Odstavec;
    $odstavec8_2->text("8.2. Účastník svým podpisem rovněž potvrzuje, že se osobně seznámil, se zněním Základní informace účastníka projektu Rodina není handicap, souhlasí s nimi a zavazuje se vzhledem k nim.");
    $odstavec8_2->predsazeni(6);
    $odstavec8_2->odsazeniZleva(6);    

$odstavec8_3 = new PDF_Odstavec;

<?php
class Projektor_Data_Vzb_UcastnikAkceDen
{
	...
	/*public static function dejStavy($ucastnik, $akceUcastnika)
	 {
		...
		$radky = $dbh->prepare($query)->execute(Projektor_Data_Vzb_UcastnikAkce::ID_S_STAV_UCASTNIK_AKCE_FK, Projektor_Data_Vzb_UcastnikAkce::TABULKA,
		Projektor_Data_Vzb_UcastnikAkce::ID_UCASTNIK_FK, $ucastnik->id,
		Projektor_Data_Vzb_UcastnikAkce::ID_AKCE_FK, $akce->id
		)->fetch_assoc();

		$stavyAkciUcastnika[$pocitadlo++] = Projektor_Data_Seznam_SStavUcastnikAkce::najdiPodleId($radky[Projektor_Data_Vzb_UcastnikAkce::ID_S_STAV_UCASTNIK_AKCE_FK]);
		}

...
class Projektor_Data_Zajemce extends Projektor_Data_HlavniObjekt
{
...
//        $seznamisco = Projektor_Data_Seznam_SISCO::vypisVse("LENGTH(`".Projektor_Data_Seznam_SISCO::KOD."`)=".$delkaKodu." AND LEFT(`".Projektor_Data_Seznam_SISCO::KOD."`, ".$delkaPrefixu.")='".$prefix."'");
...
//                ;
        ...
        $filtr = "LENGTH(`KZAM_cislo1`)=5".
                ...
                ;
        $dotazniky = Projektor_Data_FlatTable::vypisVse(self::DATABAZE, $tabulka, $filtr, "", "", $this, "", "", "", TRUE);
    ...
    {
        //TODO: tady v Projektor_Data_Zajemce jen nastav filtr a volej Projektor_Data_HlavniObjekt::vypisVse, v Projektor_HlavniObjekt zruš metodu vypisPrihlaseneNaAkci
    ...
    private static function predpoklady($iscoKod, $dotaznik)
        {
            ...
            $kzamKvalikacniPredpoklady = Projektor_Data_FlatTable::vypisVse(self::DATABAZE, "s_kzam_kvalifikacni_predpoklady", $filtr, "", "", NULL, "", "", "", TRUE);
            $predpoklad = 0;
            for ($i = 1; $i <= 5; $i++) {

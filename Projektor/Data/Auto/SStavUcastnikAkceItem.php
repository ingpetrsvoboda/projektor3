<?php
class Projektor_Data_Auto_SStavUcastnikAkceItem extends Projektor_Data_Item
{
...
###END_AUTOCODE
	...
	{
		return Projektor_Data_Seznam_SPrechodUcastnikAkce::vypisVse(Projektor_Data_Seznam_SPrechodUcastnikAkce::ID_S_STAV_PRED_FK." = {$this->id}");
	}

<?php
class Projektor_Data_Auto_SStavAkceItem extends Projektor_Data_Item
{
...
//    }
	...
	{
		return Projektor_Data_Seznam_SPrechodAkce::vypisVse(Projektor_Data_Seznam_SPrechodAkce::ID_S_STAV_PRED_FK." = {$this->id}");
	}
}
?>

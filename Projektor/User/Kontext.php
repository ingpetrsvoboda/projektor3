...
//        //TODO: session
//        if(isset($_COOKIE)) {
//            if (array_key_exists('kancelarId', $_COOKIE)) $kancelarZCookie = new Projektor_Model_Auto_CKancelarItem($_COOKIE['kancelarId']);
//            if (array_key_exists('projektId', $_COOKIE)) $projektZCookie = new Projektor_Model_Auto_CProjektItem($_COOKIE['projektId']);
//            if (array_key_exists('behId', $_COOKIE)) $behZCookie = new Projektor_Model_Auto_SBehProjektuItem($_COOKIE['behId']);
//        }
//
//        if ($povoleneProjekty) {
...
//                        }
//            //            $behyProjektu = Projektor_Model_Seznam_SBehProjektu::vypisVse();   //diky kontext filtru vraci jen behy pro $kontextUser->projekt
//                        $behyProjektu = new Projektor_Model_Auto_SBehProjektuCollection();
//                        if ($behyProjektu) {
//                            if (isset($behZCookie)) {

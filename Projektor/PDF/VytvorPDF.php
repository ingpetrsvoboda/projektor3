...
/**
 * Vytvoří pdf objekt
 * Potomek třídy Projektor_Pdf_ExtFPDF, implementuje funkce Header a Footer volané zevnitř z třídy fpdf
 * a obsahuje funkce pro tisk objektů vytvořených třídami obsaženými v package PDF
 * @author Petr Svoboda
 *
 */
class Projektor_Pdf_VytvorPdf extends Projektor_Pdf_ExtFPDF
{
  	/**
    ...
    function DebugCell ($obj, $w=0, $h=0, $txtUTF8='', $border=0, $ln=0, $align='', $fill=false, $link='')
    {
        ...
        switch ($pdfdebug->debug) 
        {
            ...
            case 2:
                ...
                $this->SetDrawColor(255, 0, 63);
                if (is_a  ($obj, Projektor_Pdf_Bunka)) 
                {

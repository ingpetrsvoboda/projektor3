...
//		$titulek->Text('Lákamí vůněhulás úmyval rohlivý jednovod lek lák hane bývá přehliv smeti. Smělý Umyslemi dopicí sudba rojskočár ří bý autný tlínům z zavěď. Umí jít A hafan bý obal stako tak úmyvatkov Buben muto. ');
    ...
    $bydliste = new Projektor_Pdf_SadaBunek();
    ...
    $bydlistePrechodne = new Projektor_Pdf_SadaBunek();
                $adresapole="";
                if (@$pdfpole["ulice2"]) {
    ...
    $vzdelaniSkolaII = new Projektor_Pdf_SadaBunek();
    ...
    $vzdelaniSkolaIII = new Projektor_Pdf_SadaBunek();
    ...
    $vzdelaniSkolaIV = new Projektor_Pdf_SadaBunek();
    ...
    $vzdelaniSkolaV = new Projektor_Pdf_SadaBunek();
    ...
    $vzdelaniSkoleniII = new Projektor_Pdf_SadaBunek();
    ...
    $vzdelaniSkoleniIII = new Projektor_Pdf_SadaBunek();
    ...
    $vzdelaniSkoleniIV = new Projektor_Pdf_SadaBunek();
    ...
    $vzdelaniSkoleniV = new Projektor_Pdf_SadaBunek();
    ...
    $specializaceVPraxi = new Projektor_Pdf_Odstavec();
    ...
    $jazykoveZnalosti = new Projektor_Pdf_Odstavec();
                $jazykoveZnalosti ->Nadpis("Jazykové znalosti");
                $jazykoveZnalosti ->VyskaPismaNadpisu(12);    
    $jazykoveZnalostiAj = new Projektor_Pdf_SadaBunek();
    ...
    $jazykoveZnalostiNj = new Projektor_Pdf_SadaBunek();   		
    ...
    $jazykoveZnalostiRj = new Projektor_Pdf_SadaBunek();                           
    ...
    $jazykoveZnalostiD1 = new Projektor_Pdf_SadaBunek();                  	
    ...
    $jazykoveZnalostiD2 = new Projektor_Pdf_SadaBunek();      		
    ...
    $predchoziZamestnaniI = new Projektor_Pdf_SadaBunek();
    ...
    $predchoziZamestnaniII = new Projektor_Pdf_SadaBunek();
    ...
    $predchoziZamestnaniIII = new Projektor_Pdf_SadaBunek();
    ...
    $predchoziZamestnaniIV = new Projektor_Pdf_SadaBunek();
    ...
    $predchoziZamestnaniV = new Projektor_Pdf_SadaBunek();
    ...
    $posledniPomer = new Projektor_Pdf_SadaBunek();
    ...
    $predstavaUplatneni = new Projektor_Pdf_Odstavec();
                $predstavaUplatneni->Nadpis("Představa o uplatnění");
                $predstavaUplatneni->VyskaPismaNadpisu(12);
    $predstavaUplatneniPopis = new Projektor_Pdf_SadaBunek();
    ...
    $predstavaUplatneniHledaOdmita = new Projektor_Pdf_SadaBunek();
    ...
    $predstavaUplatneniPozadavky = new Projektor_Pdf_SadaBunek();
    ...
    $doplnujiciUdaje = new Projektor_Pdf_Odstavec;
    ...
    $doplnujiciUdaje1 = new Projektor_Pdf_SadaBunek();
 ...
 *
    $vyplataPrimePodpory = new Projektor_Pdf_SadaBunek();

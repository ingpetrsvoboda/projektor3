...
class Projektor_Model_Ucastnik extends Projektor_Model_HlavniObjekt
{
...
//TODO: přejmenovat sloupec v db na id_ucastnik_FK a změnit konstantu    
    ...
    public static function najdiPodleId($id) {
        return parent::najdiPodleId(self::DATABAZE, $id, self::HLAVNI_OBJEKT, self::TABULKA, self::ID, self::CISLO_OBJEKTU, FALSE);
    }
    
    public static function vypisVse($filtr = "", $orderBy = "", $order = "") {
        return parent::vypisVse(self::DATABAZE, $filtr, $orderBy, $order, self::HLAVNI_OBJEKT, self::TABULKA, self::ID, self::CISLO_OBJEKTU, FALSE);        
    }   
    ...
    {
        return parent::vypisPrihlaseneNaAkci(self::DATABAZE, $idAkce, $filtr, $orderBy, $order, self::HLAVNI_OBJEKT, self::TABULKA, self::ID, self::CISLO_OBJEKTU, FALSE);
    }    
}
?>

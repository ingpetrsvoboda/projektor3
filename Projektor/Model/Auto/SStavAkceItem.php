<?php
class Projektor_Model_Auto_SStavAkceItem extends Projektor_Model_Item implements Projektor_Model_AutoItemInterface
{
...
###START_AUTOCODE
    // Nový kód pro databázi Projektor a tabulku s_stav_akce
    ...
    /**
     * Generovaná vlastnost pro tabulku s_stav_akce a sloupec id_s_stav_akce. Vlatnosti sloupce: typ=int, sloupec je primární klíč a je auto_increment
     * je vygenerována public vlastnost se jménem $id
     */
    public $id;
    /**
     * Generovaná vlastnost pro tabulku s_stav_akce a sloupec text. Vlatnosti sloupce: typ=varchar, delka=200
     */
    public $dbField°text;
    /**
     * Generovaná vlastnost pro tabulku s_stav_akce a sloupec plny_text. Vlatnosti sloupce: typ=varchar, delka=500
     */
    public $dbField°plny_text;
    /**
     * Generovaná vlastnost pro tabulku s_stav_akce a sloupec valid. Vlatnosti sloupce: typ=tinyint, default=1
     */
...
//    }
	...
	{
		return Projektor_Model_Seznam_SPrechodAkce::vypisVse(Projektor_Model_Seznam_SPrechodAkce::ID_S_STAV_PRED_FK." = {$this->id}");
	}
}
?>

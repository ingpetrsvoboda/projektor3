 ...
 * @author pes2704
 */
class Projektor_Model_Auto_CKancelarItem extends Projektor_Model_CiselnikItem implements Projektor_Model_AutoItemInterface
{
    const DATABAZE = Framework_Config::DATABAZE_PROJEKTOR;
    const TABULKA = "c_kancelar";

###START_AUTOCODE
    // Nový kód pro databázi Projektor a tabulku c_kancelar
    ...
    /**
     * Generovaná vlastnost pro tabulku c_kancelar a sloupec id_c_kancelar. Vlatnosti sloupce: typ=int, sloupec je primární klíč a je auto_increment
     * je vygenerována public vlastnost se jménem $id
     */
    public $id;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar a sloupec razeni. Vlatnosti sloupce: typ=int
     */
    public $dbField°razeni;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar a sloupec kod. Vlatnosti sloupce: typ=varchar, delka=20, default=""
     */
    public $dbField°kod;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar a sloupec text. Vlatnosti sloupce: typ=varchar, delka=200
     */
    public $dbField°text;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar a sloupec plny_text. Vlatnosti sloupce: typ=varchar, delka=500
     */
    public $dbField°plny_text;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar a sloupec valid. Vlatnosti sloupce: typ=tinyint, default=1
     */

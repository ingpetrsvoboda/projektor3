...
class Projektor_Model_Auto_SysUsersItem extends Projektor_Model_Item implements Projektor_Model_AutoItemInterface
{
...
###START_AUTOCODE
    ...
    /**
     * Generovaná vlastnost pro tabulku sys_users a sloupec tl_he_sml. Vlatnosti sloupce: typ=tinyint
     */
    public $dbField°tl_he_sml;
    /**
     * Generovaná vlastnost pro tabulku sys_users a sloupec tl_he_souhlas. Vlatnosti sloupce: typ=tinyint
     */
    public $dbField°tl_he_souhlas;
    /**
     * Generovaná vlastnost pro tabulku sys_users a sloupec tl_he_dot. Vlatnosti sloupce: typ=tinyint
     */
    public $dbField°tl_he_dot;
    ...
    public function reset()
    {
        ...
        unset($this->dbField°tl_he_sml);
        unset($this->dbField°tl_he_souhlas);
        unset($this->dbField°tl_he_dot);
    }

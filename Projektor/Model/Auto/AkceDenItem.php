<?php
class Projektor_Model_Auto_AkceDenItem extends Projektor_Model_Item implements Projektor_Model_AutoItemInterface
{
...
###END_AUTOCODE
	...
	{
		return Projektor_Model_Auto_AkceItem::najdiPodleId($this->idAkceFK);
	}

	/**
	 * Vrati instanci SUcebna k tomuto Akcedni.
	 * @return Projektor_Model_Seznam_SUcebna
	 */

	public function dejSUcebna()
	{
		return Projektor_Model_Seznam_SUcebna::najdiPodleId($this->idSUcebnaFK);
	}

	/**
	 * Vrati instanci SPersonal k tomuto Akcedni.
	 * @return Projektor_Model_Seznam_SPersonal
	 */

	public function dejSPersonal()
	{
		return Projektor_Model_Seznam_SPersonal::najdiPodleId($this->idSPersonalFK);
	}
	...
	public function prihlas($ucastnik, $sStavUcastnikAkceDen)
	{
		...
		if(!Projektor_Model_Seznam_SPrechodUcastnikAkceDen::jeMozny(NULL, $sStavUcastnikAkceDen))
		...
		$dbh->prepare($query)->execute(Projektor_Model_Vzb_UcastnikAkceDen::TABULKA, Projektor_Model_Vzb_UcastnikAkceDen::ID_UCASTNIK_FK,
		Projektor_Model_Vzb_UcastnikAkceDen::ID_AKCE_DEN_FK, Projektor_Model_Vzb_UcastnikAkceDen::ID_S_STAV_UCASTNIK_AKCE_DEN_FK,
	 ...
	 * @param Projektor_Model_Seznam_SStavUcastnikAkceDen $sStavUcastnikAkceDen Stav ucastnika vzhledem k AkceDni
	 * @return unknown_type
	 */

	public function zmenStavUcastnika($ucastnik, $sStavUcastnikAkceDen)
	{
		if(!Projektor_Model_Seznam_SPrechodUcastnikAkceDen::jeMozny($this->stavUcastnika($ucastnik), $sStavUcastnikAkceDen))
		...
		$query = "UPDATE ~1 SET ~2=:3 WHERE (~4 = :5 AND ~6 = :7)";
                $dbh->bindIdentificator('~1', Projektor_Model_Vzb_UcastnikAkceDen::TABULKA);
                $dbh->bindIdentificator('~2', Projektor_Model_Vzb_UcastnikAkceDen::ID_S_STAV_UCASTNIK_AKCE_DEN_FK);
                $dbh->bindIdentificator('~4', Projektor_Model_Vzb_UcastnikAkceDen::ID_UCASTNIK_FK);
                $dbh->bindIdentificator('~6', Projektor_Model_Vzb_UcastnikAkceDen::ID_AKCE_DEN_FK);
                $stm = $dbh->prepare($query);
                $stm->bindParam(':3', $sStavUcastnikAkceDen->id);
                $stm->bindParam(':5', $ucastnik->id);
                $stm->bindParam(':7', $this->id);
                return $stm->execute();
//		$dbh->prepare($query)->execute(Projektor_Model_Vzb_UcastnikAkceDen::TABULKA,
//		Projektor_Model_Vzb_UcastnikAkceDen::ID_S_STAV_UCASTNIK_AKCE_DEN_FK,
//		$sStavUcastnikAkceDen->id,
//		Projektor_Model_Vzb_UcastnikAkceDen::ID_UCASTNIK_FK,
//		$ucastnik->id,
//		Projektor_Model_Vzb_UcastnikAkceDen::ID_AKCE_DEN_FK,
//		$this->id);
	}
	...
	public function stavUcastnika($ucastnik)
	{
		...
		$radek = $dbh->prepare($query)->execute(Projektor_Model_Vzb_UcastnikAkceDen::ID_S_STAV_UCASTNIK_AKCE_DEN_FK, Projektor_Model_Vzb_UcastnikAkceDen::TABULKA,
		Projektor_Model_Vzb_UcastnikAkceDen::ID_UCASTNIK_FK, $ucastnik->id,
		Projektor_Model_Vzb_UcastnikAkceDen::ID_AKCE_DEN_FK, $this->id
		)->fetch_assoc();

		if($radek)
		return Projektor_Model_Seznam_SStavUcastnikAkceDen::najdiPodleId($radek[Projektor_Model_Vzb_UcastnikAkceDen::ID_S_STAV_UCASTNIK_AKCE_DEN_FK]);
		else
		return false;
	}
	...
	public function vsichniUcastnici()
	{
		...
		$radky = $dbh->prepare($query)->execute(Projektor_Model_Vzb_UcastnikAkceDen::ID_UCASTNIK_FK, Projektor_Model_Vzb_UcastnikAkceDen::TABULKA,
		Projektor_Model_Vzb_UcastnikAkceDen::ID_AKCE_DEN_FK, $this->id)->fetchall_assoc();

		foreach($radky as $radek)
		$vypis[] = Projektor_Model_Ucastnik::najdiPodleId($radek[Projektor_Model_Vzb_UcastnikAkceDen::ID_UCASTNIK_FK]);
	...
	public static function vsechnyUcastnika($ucastnik)
	{
                $dbh = Projektor_Container::getDbh(Framework_Config::DATABAZE_PROJEKTOR);
		$query = "SELECT ~1 FROM ~2 WHERE ~3=:4";
		$radky = $dbh->prepare($query)->execute(Projektor_Model_Vzb_UcastnikAkceDen::ID_AKCE_DEN_FK, Projektor_Model_Vzb_UcastnikAkceDen::TABULKA,
		Projektor_Model_Vzb_UcastnikAkceDen::ID_UCASTNIK_FK, $ucastnik->id)->fetchall_assoc();

		foreach($radky as $radek)
		$vypis[] = self::najdiPodleId($radek[Projektor_Model_Vzb_UcastnikAkceDen::ID_AKCE_DEN_FK]);

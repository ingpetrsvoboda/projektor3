<?php
class Projektor_Model_Auto_SysAccUsrKancelar3Item extends Projektor_Model_Item  implements Projektor_Model_AutoItemInterface
{

    const DATABAZE = Framework_Config::DATABAZE_PROJEKTOR;
    const TABULKA = "sys_acc_usr_kancelar3";
    const NAZEV_ZOBRAZOVANE_VLASTNOSTI = "Vazební tabulka";

###START_AUTOCODE
    // Nový kód pro databázi Projektor a tabulku sys_acc_usr_kancelar3
    ...
    /**
     * Generovaná vlastnost pro tabulku sys_acc_usr_kancelar3 a sloupec id_sys_acc_usr_kancelar3. Vlatnosti sloupce: typ=int, sloupec je primární klíč a je auto_increment
     * je vygenerována public vlastnost se jménem $id
     */
    public $id;
    /**
     * Generovaná vlastnost pro tabulku sys_acc_usr_kancelar3 a sloupec id_sys_users. Vlatnosti sloupce: typ=int
     * , sloupec je cizí klíč z tabulky sys_users a sloupce id_sys_users
     */
    public $dbField°id_sys_users;
    /**
     * Generovaná vlastnost pro tabulku sys_acc_usr_kancelar3 a sloupec id_c_prava. Vlatnosti sloupce: typ=int
     * , sloupec je cizí klíč z tabulky s_prava_data a sloupce id_c_prava
     */
    public $dbField°id_c_prava;
    /**
     * Generovaná vlastnost pro tabulku sys_acc_usr_kancelar3 a sloupec id_c_kancelar3. Vlatnosti sloupce: typ=int
     * , sloupec je cizí klíč z tabulky c_kancelar3 a sloupce id_c_kancelar3
     */
    public $dbField°id_c_kancelar3;
    ...
    public function reset()
    {
        ...
        unset($this->dbField°id_c_kancelar3);
    }

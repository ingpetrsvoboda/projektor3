 ...
 * @author pes2704
 */
class Projektor_Model_Auto_CKancelar3Item extends Projektor_Model_CiselnikItem implements Projektor_Model_AutoItemInterface
{
    const DATABAZE = Framework_Config::DATABAZE_PROJEKTOR;
    const TABULKA = "c_kancelar3";

###START_AUTOCODE
    // Nový kód pro databázi Projektor a tabulku c_kancelar3
    ...
    /**
     * Generovaná vlastnost pro tabulku c_kancelar3 a sloupec id_c_kancelar3. Vlatnosti sloupce: typ=int, sloupec je primární klíč a je auto_increment
     * je vygenerována public vlastnost se jménem $id
     */
    public $id;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar3 a sloupec id_c_projekt_FK. Vlatnosti sloupce: typ=int
     * , sloupec je cizí klíč z tabulky c_projekt a sloupce id_c_projekt
     */
    public $dbField°id_c_projekt_FK;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar3 a sloupec razeni. Vlatnosti sloupce: typ=int
     */
    public $dbField°razeni;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar3 a sloupec kod. Vlatnosti sloupce: typ=varchar, delka=20, default=""
     */
    public $dbField°kod;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar3 a sloupec text. Vlatnosti sloupce: typ=varchar, delka=200
     */
    public $dbField°text;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar3 a sloupec plny_text. Vlatnosti sloupce: typ=varchar, delka=500
     */
    public $dbField°plny_text;
    /**
     * Generovaná vlastnost pro tabulku c_kancelar3 a sloupec valid. Vlatnosti sloupce: typ=tinyint, default=1
     */

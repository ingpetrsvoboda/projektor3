<?php
/**
 * Testovací třída pro Projektor_Autocode_Generator. Třída s definicí class typu Item pro testovací běh generátoru autocode.
 * Do této třídy doplňuje geberátor vygenerovaný autocode pokud je volán s parametrem $test=TRUE.
 *
 * @author pes2704
 */
class Projektor_Model_Auto_AutocodeTestItem extends Projektor_Model_HlavniObjektItem implements Projektor_Model_AutoItemInterface
{
    const DATABAZE = Framework_Config::DATABAZE_PROJEKTOR;
    const TABULKA = "zajemce";
    const NAZEV_ZOBRAZOVANE_VLASTNOSTI = "id";
    ...
    protected $_mapovaniVlastnostItem = array(
             'smlouva' => 'Projektor_Model_Auto_ZaFlatTableItem',
             'dotaznik' => 'Projektor_Model_Auto_ZaFlatTableItem',
             'plan' => 'Projektor_Model_Auto_ZaPlanFlatTableItem',
             'ukonceni' => 'Projektor_Model_Auto_ZaUkoncFlatTableItem',
             'zamestnani' => 'Projektor_Model_Auto_ZaZamFlatTableItem',
             'test' => 'Projektor_Model_Auto_ZaTestFlatTableItem',
        );
...
###START_AUTOCODE
    ...
    /**
     * vlastnost, která je podřízeným objektem hlavního objektu a je typu Projektor_Model_Auto_ZaFlatTableItem
     */
    public $smlouva;
    ...
    /**
     * vlastnost, která je podřízeným objektem hlavního objektu a je typu Projektor_Model_Auto_ZaPlanFlatTableItem
     */
    public $plan;

    /**
     * vlastnost, která je podřízeným objektem hlavního objektu a je typu Projektor_Model_Auto_ZaUkoncFlatTableItem
     */
    public $ukonceni;

    /**
     * vlastnost, která je podřízeným objektem hlavního objektu a je typu Projektor_Model_Auto_ZaZamFlatTableItem
     */
    public $zamestnani;

    /**
     * vlastnost, která je podřízeným objektem hlavního objektu a je typu Projektor_Model_Auto_ZaTestFlatTableItem
     */
    public $test;
    ...
    /**
     * Metoda vrací vlastnost hlavního objektu Smlouva typu Projektor_Model_Auto_ZaFlatTableItem
     ...
     */
    public function Smlouva(Projektor_Model_Auto_ZaFlatTableItem &$object=NULL){
        if (isset($this->smlouva))
        {
            $object = $this->smlouva;
        } else {
            $object = new Projektor_Model_Auto_ZaFlatTableItem(); //factory na Item podřízené vlastnosti - očekává název sloupce s FK id_zajemce
    ...
    /**
     * Metoda vrací vlastnost hlavního objektu Dotaznik typu Projektor_Model_Auto_ZaFlatTableItem
     * @param Projektor_Model_Auto_ZaFlatTableItem $object Tento parametr při volání metody nikdy NEZADÁVEJTE. Jedná se pouze o hack pro type hinting.
     * @return \Projektor_Model_Auto_ZaFlatTableItem
     */
    public function Dotaznik(Projektor_Model_Auto_ZaFlatTableItem &$object=NULL){
    ...
    /**
     * Metoda vrací vlastnost hlavního objektu Plan typu Projektor_Model_Auto_ZaPlanFlatTableItem
     ...
     */
    public function Plan(Projektor_Model_Auto_ZaPlanFlatTableItem &$object=NULL){
        if (isset($this->plan))
        {
            $object = $this->plan;
        } else {
            $object = new Projektor_Model_Auto_ZaPlanFlatTableItem(); //factory na Item podřízené vlastnosti - očekává název sloupce s FK id_zajemce
            $object->where("id_zajemce", "=", $this->id);
    ...
    /**
     * Metoda vrací vlastnost hlavního objektu Ukonceni typu Projektor_Model_Auto_ZaUkoncFlatTableItem
     ...
     */
    public function Ukonceni(Projektor_Model_Auto_ZaUkoncFlatTableItem &$object=NULL){
        if (isset($this->ukonceni))
        {
            $object = $this->ukonceni;
        } else {
            $object = new Projektor_Model_Auto_ZaUkoncFlatTableItem(); //factory na Item podřízené vlastnosti - očekává název sloupce s FK id_zajemce
            $object->where("id_zajemce", "=", $this->id);
    ...
    /**
     * Metoda vrací vlastnost hlavního objektu Zamestnani typu Projektor_Model_Auto_ZaZamFlatTableItem
     ...
     */
    public function Zamestnani(Projektor_Model_Auto_ZaZamFlatTableItem &$object=NULL){
        if (isset($this->zamestnani))
        {
            $object = $this->zamestnani;
        } else {
            $object = new Projektor_Model_Auto_ZaZamFlatTableItem(); //factory na Item podřízené vlastnosti - očekává název sloupce s FK id_zajemce
            $object->where("id_zajemce", "=", $this->id);
    ...
    /**
     * Metoda vrací vlastnost hlavního objektu Test typu Projektor_Model_Auto_ZaTestFlatTableItem
     ...
     */
    public function Test(Projektor_Model_Auto_ZaTestFlatTableItem &$object=NULL){
        if (isset($this->test))
        {
            $object = $this->test;
        } else {
            $object = new Projektor_Model_Auto_ZaTestFlatTableItem(); //factory na Item podřízené vlastnosti - očekává název sloupce s FK id_zajemce
            $object->where("id_zajemce", "=", $this->id);
    ...
    public function __set($nazevVlastnosti, $value) {
        ...
        return parent::__set($nazevVlastnosti, $value);
    }

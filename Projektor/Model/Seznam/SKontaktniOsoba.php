...
class Projektor_Model_Seznam_SKontaktniOsoba extends Projektor_Model_Item
{
	public $id;
	public $jmeno;
	public $prijmeni;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Projektor_Model_Seznam_SKontaktniOsoba($radek[self::JMENO], $radek[self::PRIJMENI], $radek[self::TELEFON_PRACE], $radek[self::TELEFON_MOBIL],

...
class Projektor_Model_Seznam_SStavUcastnikAkceDen extends Projektor_Model_Item
{
	public $id;
	public $text;
	public $plnyText;
	...
	static function najdiPodleId($id)
	{
		...
		return new Projektor_Model_Seznam_SStavUcastnikAkceDen($radek[self::TEXT], $radek[self::PLNY_TEXT], $radek[self::ID]);
	}
	...
	{
		return Projektor_Model_Seznam_SPrechodUcastnikAkceDen::vypisVse(Projektor_Model_Seznam_SPrechodUcastnikAkceDen::ID_S_STAV_PRED_FK." = {$this->id}");
	}

...
class Projektor_Model_Seznam_SPrechodUcastnikAkce extends Projektor_Model_Item
{
	public $id;
	public $text;
	public $plnyText;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Projektor_Model_Seznam_SPrechodUcastnikAkce($radek[self::TEXT], $radek[self::PLNY_TEXT],
	 ...
	 * @param Projektor_Model_Seznam_SStavUcastnikAkce $stavPred Stav ucastnika pred prechodem, tj.soucasny stav.
	 * @param Projektor_Model_Seznam_SStavUcastnikAkce $stavPo Stav ucastnika po prechodu, tj budouci stav.

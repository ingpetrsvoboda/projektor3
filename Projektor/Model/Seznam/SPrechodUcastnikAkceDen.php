...
class Projektor_Model_Seznam_SPrechodUcastnikAkceDen extends Projektor_Model_Item
{
	public $id;
	public $text;
	public $plnyText;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Projektor_Model_Seznam_SPrechodUcastnikAkceDen($radek[self::TEXT], $radek[self::PLNY_TEXT],
	 ...
	 * @param Projektor_Model_Seznam_SStavUcastnikAkceDen $stavPred Stav ucastnika pred prechodem, tj.soucasny stav.
	 * @param Projektor_Model_Seznam_SStavUcastnikAkceDen $stavPo Stav ucastnika po prechodu, tj budouci stav.

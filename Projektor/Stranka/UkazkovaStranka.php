...
class Projektor_Stranka_/*jmeno tridy*/ extends Projektor_Stranka_Base implements Projektor_Stranka_Interface
{
	const JMENO = "Projektor_Stranka_/*jmeno tridy*/";
	...
	private function potomekNeni()
	{
		...
		$akcej->odkaz = $this->cesta->potomekUri("Projektor_Stranka_AkceJ", array("id" => $akcej->id))/*"test.php?cesta=akcem~akcej({$akcej->id})"*/;

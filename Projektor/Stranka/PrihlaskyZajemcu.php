<?php
class Projektor_Stranka_PrihlaskyZajemcu extends Projektor_Stranka_FlatTable_Seznam
{
...
//            $formularHTML = $filtrovaciFormular->toHtml();
	...
	protected function main°potomek°Projektor_Stranka_PrihlaskaZajemce°detail()
        {
            parent::main°potomek°Projektor_Stranka_FlatTableJ°detail();
        }

        protected function generujHlavickuTabulky()
        {
                /* Hlavicka tabulky */
		$hlavickaTabulky = new Projektor_Stranka_Element_Hlavicka($this->cesta);
                ...
                $hlavickaTabulky->pridejSloupec("id_c_region_FK", "idCRegion",
                            ...
                            "Projektor_Data_Ciselnik::najdiPodleId(Projektor_App_Config::DATABAZE_PERSONAL_SERVICE, 'region', Projektor_Stranka::SLOT_PRO_ID, TRUE, TRUE)","text");

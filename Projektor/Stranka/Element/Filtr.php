 ...
 * @author Marek Petko
 */
class Projektor_Stranka_Element_Filtr
{
    public $pravidla;
    ...
    public static function equals($sloupceHodnoty)
    {
        ...
        foreach($sloupceHodnoty as $sloupec => $hodnota)
            if($hodnota)
                $filtr->pravidla[] = new Projektor_Stranka_Element_Filtr_Pravidlo($sloupec, Projektor_Stranka_Element_Filtr::EQUALS, $hodnota);
    ...
    public static function like($sloupceHodnoty = NULL)
    {
        ...
        if ($sloupceHodnoty) {
            foreach($sloupceHodnoty as $sloupec => $hodnota)
            if($hodnota)
                $filtr->pravidla[] = new Projektor_Stranka_Element_Filtr_Pravidlo($sloupec, Projektor_Stranka_Element_Filtr::LIKE, $hodnota, true, true);            
        }

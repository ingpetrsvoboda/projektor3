<?php
class Projektor_Controller_Page_PrihlaskyZajemcu extends Projektor_Controller_Page_FlatTable_Seznam
{
...
//            $formularHTML = $filtrovaciFormular->toHtml();
	...
	protected function main°potomek°Projektor_Controller_Page_PrihlaskaZajemce°detail()
        {
            parent::main°potomek°Projektor_Controller_Page_FlatTableJ°detail();
        }
		...
		$hlavickaTabulky = new Projektor_Controller_Page_Element_Hlavicka($tridaData, $this);
                ...
                $hlavickaTabulky->pridejSloupec("id_c_region_FK", "idCRegion",
                            "id_c_region_FK", "Projektor_Model_Ciselnik::vypisVse(Framework_Config::DATABAZE_PERSONAL_SERVICE, 'region', '', '', '', '', TRUE, TRUE)",
                            "Projektor_Model_Ciselnik::najdiPodleId(Framework_Config::DATABAZE_PERSONAL_SERVICE, 'region', Projektor_Stranka::SLOT_PRO_ID, TRUE, TRUE)","text");

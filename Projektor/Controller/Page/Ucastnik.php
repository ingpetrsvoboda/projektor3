 <?php
class Projektor_Controller_Page_Ucastnik extends Projektor_Controller_Page_HlavniObjekt_Detail
{
	...
	{
		$akce = Projektor_Model_Auto_AkceItem::najdiPodleId($this->parametry["id_akce"]);
                $this->novaPromenna("nadpis", "Přihlášení účastníka na akci");

                try
		{
                    //TODO: Nedodělek - pevně zadaný parametr 2!
			$akce->prihlas(Projektor_Model_Ucastnik::najdiPodleId($this->parametry["id"]), Projektor_Model_Seznam_SStavUcastnikAkce::najdiPodleId(2), Projektor_Model_Seznam_SStavUcastnikAkceDen::najdiPodleId(2));

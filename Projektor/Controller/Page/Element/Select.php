...
class Projektor_Controller_Page_Element_Select
{
	private $form;
	private $elementGrid;
	private $sloupce;
	 ...
	 */
	public function __construct(HTML_QuickForm $form, Projektor_Model_Collection $collection, $zobrazovanaVlastnost, $nazev, $popisek)
	{
		$this->form = $form;
                $poleSelect[""] = "";

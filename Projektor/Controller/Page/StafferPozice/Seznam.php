<?php
class Projektor_Controller_Page_StaferPozice_Seznam extends Projektor_Controller_Page_Seznam
{
    nemám databázi!
...
//        const NAZEV_DATOVEHO_OBJEKTU_MNOZNE = "Firmy";
    ...
    public function potomekNeni()
    {
        ...
        $tlacitka = array
        (
            new Projektor_Controller_Page_Element_Tlacitko("Nová firma", $this->uzel->potomekUri("Projektor_Controller_Page_Firma_Detail"))
        );
...
/* ------------------------------------------------------------------------------------ */
    ...
    protected function generujTlacitkaProSeznam($firma)
    {
        $tlacitka = array
            (
                    new Projektor_Controller_Page_Element_Tlacitko("Detail", $this->uzel->potomekUri("Projektor_Controller_Page_Firma_Menu", array("id" => $firma->id, "zmraz" => 1)), "tlacitko"),
            );
        return $tlacitka;
    }
    ...
    {
            /* Hlavicka tabulky */
            $hlavickaTabulky = new Projektor_Controller_Page_Element_Hlavicka($tridaData, $this->uzel);

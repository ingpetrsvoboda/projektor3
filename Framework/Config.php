...
abstract class Framework_Config
{
...
// ostatní konstanty třídy
    /**
     * konstanta označují typ databáze MySQL - odpovídá označení db driveru
     */
    const DB_TYPE_MYSQL = "mysql";
    /**
     * konstanta označují typ databáze MSSQL - odpovídá označení db driveru
     */
    ...
    private static function prevedSimpleXMLObjectNaObjekt($simpleXMLObject)
    {
